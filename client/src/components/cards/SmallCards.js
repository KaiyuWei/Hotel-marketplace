...
const SmallCard = ({h, handleHotelDelete = (f) => f, 
    ...
    // Small card is not in the Switch in App.js. thus it cannot access to the prop history.
    // so we use the history hooker here to access to the history
    return(
        <>
            <div className="card mb-3">
                <div className="row no-gutters">
                    <div className="col-md-4">
                        ...
                        <img src="http://via.placeholder.com/900x500.png?text=MERN+Booking" 
                            alt="default image"
                            className="card-image img img-fluid" 
                        />}
                    </div>
                    <div className="col-md-8">
                        <div className="card-body">
                            <h3 className="card-title">{h.title} <span className="float-right text-primary">
                                ...
                                <p className="card-text">{h.bed} {h.bed <= 1 ? " bed" : " beds"}</p>
                                <p className="card-text">
